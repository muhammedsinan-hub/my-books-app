...
• CRUD APIs: GET all (with pagination), POST, GET by ID, PUT, DELETE
• Validation, centralized error handling, .env.sample, Postman collection
Frontend (React + Vite)
...
<img width="1920" height="1008" alt="totalpages" src="https://github.com/user-attachments/assets/57750de6-a8c1-42ff-8c4c-39709959145e" />
